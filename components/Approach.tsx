    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card
          ...
          description="Once we agree on the plan, I will play my favorite playslist or put some random song to vibe and dive into coding. From initial skteches to polished code, I keep you updated every step of the way."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="This is where magic happens! Based on the approved design, I'll translate everything into functional code, building your website from scratch."
        >
          <CanvasRevealEffect
            animationSpeed={3}
